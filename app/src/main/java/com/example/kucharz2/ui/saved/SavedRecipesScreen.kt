package com.example.kucharz2.ui.saved
...
import com.example.kucharz2.ui.recipes.RecipeDetailsDialog

@Composable
fun SavedRecipesScreen(viewModel: SavedRecipesViewModel = hiltViewModel()) {
